...
source firmware. The Rust constant checks cover IQS9151 product/register
addresses, reset/gesture bits, dynamic-scale bounds, and timing values. It also
checks left/right IQS9151 Kconfig parity and the
...
source keymap after documented RMK deltas are applied. It also resolves every
